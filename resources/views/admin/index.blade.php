...
<body class="nav-fixed bg-light">
    ...
    <nav class="top-app-bar navbar navbar-expand navbar-dark bg-dark">
        <div class="container-fluid px-4">
            ...
            <!-- Navbar brand-->
            <a class="navbar-brand me-auto" href="{{ route("admin.projects.index")}}"><div class="text-uppercase font-monospace">Material Admin Pro</div></a>
            <!-- Navbar items-->
            ...
            <nav class="drawer accordion drawer-light bg-white" id="drawerAccordion">
                <div class="drawer-menu">
                    <div class="nav">
                        ...
                        <div class="collapse show" id="collapseDashboards" aria-labelledby="headingOne" data-bs-parent="#drawerAccordion">
                            <nav class="drawer-menu-nested nav">
                                <a class="nav-link active" href="app-dashboard-default.html">Default</a>
                            ...
                            <div class="card card-raised h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="row gx-4">
                                        ...
                                        <div class="col-12 col-xxl-10"><canvas id="dashboardBarChart" width="576" height="288" style="display: block; box-sizing: border-box; height: 288px; width: 576px;"></canvas></div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-raised h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex h-100 w-100 align-items-center justify-content-center">
                                        <div class="w-100" style="max-width: 20rem"><canvas id="myPieChart" width="244" height="244" style="display: block; box-sizing: border-box; height: 244px; width: 244px;"></canvas></div>
                                    </div>
                                </div>
                                <div class="card-footer bg-transparent position-relative ripple-gray">
                                    <a class="d-flex align-items-center justify-content-end text-decoration-none stretched-link text-primary" href="#!">
