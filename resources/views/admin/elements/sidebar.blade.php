    ...
    <nav class="drawer accordion drawer-light bg-white" id="drawerAccordion">
        <div class="drawer-menu">
            <div class="nav">
                ...
                <!-- Drawer link (Charts)-->
                <a class="nav-link" href="{{ route('admin.permissions.roles.index') }}">
                    <div class="nav-link-icon"><i class="bi bi-collection"></i></div>
                ...
                <div class="drawer-menu-divider"></div>
                <!-- Drawer section heading (Plugins)-->
                <div class="drawer-menu-heading">Configurations</div>
                ...
                <a class="nav-link" href="{{ route('admin.priority.index') }}">
                    <div class="nav-link-icon"><i class="bi bi-collection"></i></div>
                    Priorités
                </a>
